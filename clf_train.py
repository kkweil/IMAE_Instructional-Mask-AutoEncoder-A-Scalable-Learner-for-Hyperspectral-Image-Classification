...
if __name__ == '__main__':
    ...
    if pretrain:
        optimizer = torch.optim.AdamW([
            ...
            {'params': hsiclf_15p_204c_sstiny_model.pos_embed.parameters(), 'lr': 1e-5},
            {'params': hsiclf_15p_204c_sstiny_model.blocks.parameters(), 'lr': 1e-5},
            {'params': hsiclf_15p_204c_sstiny_model.norm.parameters(), 'lr': 1e-5},
    ...
    if os.path.exists('clf_record'):
        ...
        model_archive = f'clf_record/PU15_pertrained1'
